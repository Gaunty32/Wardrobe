...
export default function Products() {
  ...
  // Form state
  const [formData, setFormData] = useState({ name: "", sku: "", description: "", unitPrice: 0, stockQuantity: 0 });
  ...
  const openCreateDialog = () => {
    setFormData({ name: "", sku: "", description: "", unitPrice: 0, stockQuantity: 0 });
                    ...
                    {products.map((product) => (
                      <TableRow key={product.id} className="group hover:bg-muted/30">
                        ...
                        <TableCell className="text-right">
                          <span className={product.stockQuantity && product.stockQuantity <= 5 ? "text-red-600 font-bold" : ""}>
