      ...
      <div className="w-[55%] relative h-[60vh]">
        ...
        {nodes.map((node, i) => (
          ...
          >
            ...
            <div className="mt-4 font-bold text-slate-200 tracking-wide uppercase text-sm">{node.label}</div>
          </motion.div>
        ))}

        {phase >= 5 && (
          <motion.div
            className="absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-cyan-400 rounded-sm z-20"
