...
const IMAGES = [
  ...
  { src: 'https://www.selectuniforms.co.uk/wp-content/uploads/measuring-2x.jpg', alt: 'Workwear on site measuring' },
  { src: 'https://www.selectuniforms.co.uk/wp-content/uploads/measuring-3x.jpg', alt: 'Uniform on site measuring' },
  { src: 'https://www.selectuniforms.co.uk/wp-content/uploads/measuring-4x.jpg', alt: 'Staff clothing on site measuring' },
];
    ...
    <div className="flex flex-col w-full">
      ...
      <section className="py-16 container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-6 text-lg text-gray-700 leading-relaxed mb-10">
          ...
          <p>
            Upon receipt of their personal Uniform Pack, issued to their correct measurement instructions, their uniform issue will be accurate and complete. We achieve a success rate for fit of <strong>over 95%</strong> — impressive results which bear out the success of the Measurement and Fitting Sessions!
          </p>
        </div>
