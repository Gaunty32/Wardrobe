    ...
    <div className="bg-topbar text-topbar-foreground text-xs py-2 hidden md:block">
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4 text-[11px] font-semibold tracking-wider">
          ...
          <a href="https://wardrobe.selectbranding.co.uk/order-system" className="hover:text-accent transition-colors" target="_blank" rel="noreferrer">EMBROIDERY PORTAL</a>
        </div>
      </div>
    </div>
  );
