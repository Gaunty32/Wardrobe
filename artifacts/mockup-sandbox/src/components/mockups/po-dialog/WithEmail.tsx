...
import { Mail, FileText, Send, Loader2, CheckCircle, TriangleAlert, CalendarDays, PackageCheck } from "lucide-react";

const items = [
  { id: 1, code: "PS0010", name: "Tricolore Left Sleeve", hasFile: true },
  { id: 2, code: "PS0009", name: "Sponsors Right Sleeve", hasFile: true },
  { id: 3, code: "PS0008", name: "Sponsors Left Sleeve", hasFile: true },
  { id: 4, code: "PS0012", name: "Fast Lane Club Left Chest Print", hasFile: true },
  { id: 5, code: "PS0007", name: "Chubb Right Chest Logo", hasFile: true },
    ...
    <div className="min-h-screen bg-black/40 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md flex flex-col" style={{ maxHeight: "90vh" }}>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
          {/* Email on file */}
          <div className="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm flex items-center gap-2">
            <Mail className="w-4 h-4 text-gray-400 shrink-0" />
            <span className="text-gray-700">orders@raptorprinters.co.uk</span>
          </div>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-gray-400">6/6 ready</span>
            </div>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex items-center gap-2 flex-wrap">
          ...
          <button className="flex items-center gap-1.5 px-3 py-2 rounded-md text-sm font-medium text-white"
